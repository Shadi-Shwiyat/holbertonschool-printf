...
int main(void)
{
	...
	_printf("The value x is : %i and the value y is : %i, the sum of both is : %i\n", x, y, (x + y));
    ...
    _printf(NULL);
    _printf("This is a fake specifier : %k\n");
    len = _printf("This is a null termination char %c\n", '\0');
    len2 = printf("This is a null termination char %c\n", '\0');
   _printf("The length of the string with null terminator is :%i\n", len);
